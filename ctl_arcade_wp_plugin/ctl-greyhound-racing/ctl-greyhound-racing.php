<?php
    /*
    Plugin Name: CTL Arcade - Greyhound Racing
    Plugin URI: http://www.codethislab.com/
    Description: Greyhound Racing for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeGreyhoundRacing {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-greyhound-racing";
        private $_szPluginName              = "Greyhound Racing";
        private $_szAspectRatio             = "4:3";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "greyhound, virtual dogs, greyound race, dog racing, casino, casino games, 3d, gambling games, 3d game, 3d casino game, poker, slot, virtual dog, greyhounds, video poker";
    ...
    $g_oCTLArcadeGreyhoundRacing =  new CTLArcadeGreyhoundRacing();
